...
function makeGalleryMarkup(object) {
    return object.map(({ original , preview , description  })=>`<li class="gallery__item">
...
galleryElRef.insertAdjacentHTML("beforeend", makeGalleryMarkup((0, _galleryItems.galleryItems)));
new (0, _simplelightboxDefault.default)(".gallery__link", {
    captionsData: "alt",
    captionDelay: 250
});
